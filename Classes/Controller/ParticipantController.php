...
class ParticipantController extends AbstractController {
	 ...
	 * @return \Cps\DakosyReservations\Domain\Model\Dto\PersonDemand
	 */
	protected function createDemandFromSettings($settings) {
		/**@var \Cps\DakosyReservations\Domain\Model\Dto\PersonDemand $demand**/
		$demand = $this->objectManager->get('\\Cps\\DakosyReservations\\Domain\\Model\\Dto\\PersonDemand');
		$demand->setTypes((string) \Cps\DakosyReservations\Domain\Model\Person::PERSON_TYPE_PARTICIPANT);
