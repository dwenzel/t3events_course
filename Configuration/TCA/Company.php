...
$GLOBALS['TCA']['tx_dakosyreservations_domain_model_company'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_dakosyreservations_domain_model_company']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, address, zip, city',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, address, zip, city, country, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_dakosyreservations_domain_model_company.pid=###CURRENT_PID### AND tx_dakosyreservations_domain_model_company.sys_language_uid IN (-1,0)',
			),
		),
