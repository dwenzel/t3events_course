...
$GLOBALS['TCA']['tx_dakosyreservations_domain_model_audience'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_dakosyreservations_domain_model_audience']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_dakosyreservations_domain_model_audience.pid=###CURRENT_PID### AND tx_dakosyreservations_domain_model_audience.sys_language_uid IN (-1,0)',
			),
		),
