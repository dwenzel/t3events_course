...
class LessonController extends AbstractController{
	 ...
	 * Course Repository
	 *
	 * @var \Cps\DakosyReservations\Domain\Repository\CourseRepository
	 * @inject
	 */
	 ...
	 * Audience Repository
	 *
	 * @var \Cps\DakosyReservations\Domain\Repository\AudienceRepository
	 * @inject
	 */
	 ...
	 * @return void
	 */
	public function showAction(\Cps\DakosyReservations\Domain\Model\Lesson $lesson) {
	...
	protected function createDemandFromSettings($settings) {
		/** @var \Cps\DakosyReservations\Domain\Model\Dto\LessonDemand $demand */
		$demand = $this->objectManager->get('\\Cps\\DakosyReservations\\Domain\\Model\\Dto\\LessonDemand');
	 ...
	 *
	 * @param \Cps\DakosyReservations\Domain\Model\Dto\LessonDemand $demand
	 * @param \array $overwriteDemand
	 */
