 ...
 */
use Cps\DakosyReservations\Controller\AbstractController;
use Cps\DakosyReservations\Domain\Model\Dto\ReservationDemand;
...
class BookingsController extends AbstractController {
	 ...
	 *
	 * @var \Cps\DakosyReservations\Domain\Repository\NotificationRepository
	 * @inject
	 */
	...
	public function listAction() {
		/** @var \Cps\DakosyReservations\Domain\Model\Dto\ReservationDemand $demand */
	 ...
	 * @return void
	 */
	public function editAction(\Cps\DakosyReservations\Domain\Model\Reservation $reservation) {
		$this->view->assign('reservation', $reservation);
	}
	 ...
	 * @return void
	 */
	public function updateAction(\Cps\DakosyReservations\Domain\Model\Reservation $reservation) {
	 ...
	 * @return void
	 */
	public function cancelAction(\Cps\DakosyReservations\Domain\Model\Reservation $reservation, $reason) {
		switch($reason) {
			case 'byDakosy':
				$newStatus = \Cps\DakosyReservations\Domain\Model\Reservation::STATUS_CANCELED_BY_DAKOSY;
				break;
			case 'withCosts':
				$newStatus = \Cps\DakosyReservations\Domain\Model\Reservation::STATUS_CANCELED_WITH_COSTS;
				break;
			case 'noCharge':
				$newStatus = \Cps\DakosyReservations\Domain\Model\Reservation::STATUS_CANCELED_NO_CHARGE;
				break;
			default:
				break;
		}
	 ...
	 * @param \Cps\DakosyReservations\Domain\Model\Notification $newNotification
	...
	protected function createDemandFromSettings($settings) {
		...
		$demand = $this->objectManager->get('Cps\\DakosyReservations\\Domain\\Model\\Dto\\ReservationDemand');
