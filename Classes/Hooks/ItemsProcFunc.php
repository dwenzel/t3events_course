<?php
namespace Cps\DakosyReservations\Hooks;
/***************************************************************
 *  Copyright notice
 *
...
use TYPO3\CMS\Backend\Utility\BackendUtility;
	...
	class ItemsProcFunc {
	    ...
	    public function user_templateLayout(array &$config) {
	    	...
	    	if (isset($GLOBALS['TYPO3_CONF_VARS']['EXT']['tx_dakosyreservations']['templateLayouts'])
	    	...
	    	if (is_numeric($config['row']['pid'])) {
	    		...
	    		if (isset($pagesTsConfig['tx_dakosyreservations.']['templateLayouts.']) && is_array($pagesTsConfig['tx_dakosyreservations.']['templateLayouts.'])) {

	    			// Add every item
	    			foreach ($pagesTsConfig['tx_dakosyreservations.']['templateLayouts.'] as $key => $label) {
	    				$additionalLayout = array(
